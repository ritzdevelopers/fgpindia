...
function closeMobileMenu() {
    ...
    // Close About Us dropdown if open
    const aboutUsDropdown = document.getElementById('mobile-about-us-dropdown');
    const aboutUsArrow = document.getElementById('mobile-about-us-arrow');
    if (aboutUsDropdown && aboutUsArrow) {
        aboutUsDropdown.classList.add('hidden');
        aboutUsDropdown.classList.remove('flex');
        aboutUsArrow.classList.remove('rotate-90');
    }
...
// ============================================
function initMobileAboutUsDropdown() {
    const aboutUsToggle = document.getElementById('mobile-about-us-toggle');
    const aboutUsDropdown = document.getElementById('mobile-about-us-dropdown');
    const aboutUsArrow = document.getElementById('mobile-about-us-arrow');
    
    if (!aboutUsToggle || !aboutUsDropdown || !aboutUsArrow) {
    ...
    aboutUsToggle.addEventListener('click', function (e) {
        ...
        if (isDropdownOpen) {
            ...
            aboutUsDropdown.classList.add('flex');
            aboutUsArrow.classList.add('rotate-90');
            
            // Animate dropdown with GSAP if available
            if (typeof gsap !== 'undefined') {
                gsap.fromTo(aboutUsDropdown, 
                    { opacity: 0, y: -10 },
...
// Initialize mobile About Us dropdown when DOM is ready
if (document.readyState === 'loading') {
    document.addEventListener('DOMContentLoaded', initMobileAboutUsDropdown);
} else {
    initMobileAboutUsDropdown();
}
...
He also lends his expertise in engaging with law enforcement agencies, adeptly addressing jurisdictional issues and overcoming roadblocks to expedite ongoing matters within the organisation. His extensive experience includes effectively managing public order and contributing to decision-making on vigilance and policy matters. He is currently handling and demonstrating a profound interest and active involvement in the real estate sector, which is the second-largest economy in India.`
    },
    {
        ...
        name: "Avdhesh Kumar Goel FCA, ACS, AICWA",
...
function handleMapClick() {
    window.open('https://www.google.com/maps/place/India+Forbes/@28.5308659,76.9364693,50243m/data=!3m1!1e3!4m7!3m6!1s0x390d1b001d9ade67:0x8c095c4edf84185e!8m2!3d28.537339!4d77.0926583!15sChhpbmRpYSBmb3JiZXMgZ29vZ2xlIG1hcHMiA4gBAZIBFGNvbnN0cnVjdGlvbl9jb21wYW554AEA!16s%2Fg%2F11vss7jhmn?coh=277533&entry=tts&g_ep=EgoyMDI2MDExOS4wIPu8ASoKLDEwMDc5MjA2N0gBUAM%3D&skid=a1e8aa80-e515-4f0d-86c2-0205d2649ec5', '_blank');
}